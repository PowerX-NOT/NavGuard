...
public class DevicesFragment extends ListFragment {
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v, int position, long id) {
        ...
        Fragment fragment = new EmergencyTerminalFragment();
        fragment.setArguments(args);
        getParentFragmentManager().beginTransaction().replace(R.id.fragment, fragment, "emergency_terminal").addToBackStack(null).commit();
    }
}
